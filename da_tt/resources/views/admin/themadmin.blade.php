                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Thêm nhân viên
	 							 ...
	 							 <form action="{{url('/checkThemad')}}" method="post">
                                            {{ csrf_field() }}
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Tên nhân viên</label>
                                                <input name="adTen" class="form-control py-4" id="inputEmailAddress" type="text"  />
                                                <span style="color:red">{{$errors->first('adTen')}}</span>
                                            </div>
                                              <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress"> Tài khoản</label>
                                                <input name="adAcc" class="form-control py-4" id="inputEmailAddress" type="text"  />
                                                <span style="color:red">{{$errors->first('adAcc')}}</span>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputPassword">Password</label>
                                                <input name="adPass" class="form-control py-4" id="inputPassword" type="text"  />
